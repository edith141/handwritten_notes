...
for index, letter in enumerate(text):
    ...
    if(add_sub == 0):
        if (side_item):
            if (pen_col % 2 == 0):
                draw.text((llwidth+70,twidth+human), letter, fill = (0,15,85,255), font = myfont)
            else:
                draw.text((llwidth+70,twidth+human), letter, fill = (28,28,28), font = myfont)
        else:
            if (pen_col % 2 == 0):
                draw.text((page_lmar+lwidth,twidth+human), letter, fill = (0,15,85,255), font = myfont)
            else:
                draw.text((page_lmar+lwidth,twidth+human), letter, fill = (28,28,28), font = myfont)
    else:
        if (side_item):
            if (pen_col % 2 == 0):
                draw.text((llwidth+70,twidth-human), letter, fill = (0,15,85,255), font = myfont)
    ...
    if (side_item):
        llwidth += draw.textsize(letter, myfont)[0]
    else:
